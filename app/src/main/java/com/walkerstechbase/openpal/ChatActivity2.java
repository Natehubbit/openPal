...
public class ChatActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatObject = (ChatObject2) getIntent().getSerializableExtra("chatObject");
        ...
        mChatMessagesDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if(dataSnapshot.exists()){
                    ...
                    MessageObject2 mMessage = new MessageObject2(dataSnapshot.getKey(), creatorID, text, mediaUrlList);
    ...
    private void updateDatabaseWithNewMessage(DatabaseReference newMessageDb, Map newMessageMap){
        ...
        for(UserObject2 mUser : mChatObject.getUserObjectArrayList()){
    ...
    private void initializeMessage() {
        ...
        mChatAdapter = new MessageAdapter2(messageList);
    ...
    private void initializeMedia() {
        ...
        mMediaAdapter = new MediaAdapter2(getApplicationContext(), mediaUriList);
